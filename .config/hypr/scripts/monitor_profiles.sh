...
function changeProfile {
    ...
    if [[ -f "$HOME/.config/hypr/config/monitors.conf.d/$hash.conf" ]]; then
        # Switch to this setup's config
        ln -sf "$HOME/.config/hypr/config/monitors.conf.d/$hash.conf" "$HOME/.config/hypr/config/monitors.conf" 
    else
        # Create and switch to this monitor's config
        cp "$HOME/.config/hypr/config/monitors.conf.d/default.conf" "$HOME/.config/hypr/config/monitors.conf.d/$hash.conf"
        ln -sf "$HOME/.config/hypr/config/monitors.conf.d/$hash.conf" "$HOME/.config/hypr/config/monitors.conf" 
    fi
